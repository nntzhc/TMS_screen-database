...
//    QString control_str = QString("create table p")+QString::number(id)+QString(" (id int primary key, name text,gender text, age int,times int)");
//    sqlite.execute(control_str);

    QString control_str = QString("create table p")+QString::number(id)+QString(" (id int primary key, name text,gender text, age int,times int)");
    sqlite.execute(control_str);

//    control_str = QString("INSERT INTO p")+QString::number(id)+QString(" VALUES(")\
//                                                            +QString::number(id)\
//                                                            +QString(",")+name\
//                                                            +QString(",")+gender\
//                                                            +QString(",")+QString::number(age)\
//                                                            +QString(",")+QString::number(times)\
//                                                            +QString(")");
//    sqlite.execute(control_str);
